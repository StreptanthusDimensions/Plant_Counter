...
Latest version is 0.1.4d

[Download](https://github.com/StreptanthusDimensions/Plant_Counter/raw/develop/target/Plant_Counter-0.1.4d.jar) the file `Plant_Counter-x.y.jar` from the `target` directory and place it in the plugins folder of Fiji.  Restart Fiji.
